...
module InstructionCache (
  ...
  reg [17:0] decodeStage_hit_0_address;
  ...
  assign _zz_14_ = (! lineLoader_flushCounter[9]);
  ...
  assign _zz_4_ = lineLoader_flushCounter[9];
  ...
  assign _zz_5_ = 1'b1;
  assign lineLoader_write_tag_0_valid = ((_zz_5_ && lineLoader_fire) || (! lineLoader_flushCounter[9]));
  ...
  assign _zz_6_ = io_cpu_prefetch_pc[13 : 5];
  ...
  assign fetchStage_read_waysValues_0_tag_address = _zz_8_[19 : 2];
  assign _zz_9_ = io_cpu_prefetch_pc[13 : 2];
  ...
  assign decodeStage_hit_hits_0 = (decodeStage_hit_0_valid && (decodeStage_hit_0_address == decodeStage_mmuRsp_physicalAddress[31 : 14]));
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      lineLoader_flushCounter <= (10'b0000000000);
      ...
      if(_zz_14_)begin
        lineLoader_flushCounter <= (lineLoader_flushCounter + (10'b0000000001));
      end
      if(io_flush_cmd_valid)begin
...
module DataCache (
  ...
  reg [17:0] tagsWriteCmd_payload_data_address;
  ...
  reg [17:0] tagsWriteLastCmd_payload_data_address;
  reg  dataReadCmd_valid;
  reg [11:0] dataReadCmd_payload;
  reg  dataWriteCmd_valid;
  reg [11:0] dataWriteCmd_payload_address;
  reg [31:0] dataWriteCmd_payload_data;
  reg [3:0] dataWriteCmd_payload_mask;
  reg [8:0] way_tagReadRspOneAddress;
  wire [19:0] _zz_4_;
  wire  _zz_5_;
  reg  tagsWriteCmd_valid_regNextWhen;
  reg [8:0] tagsWriteCmd_payload_address_regNextWhen;
  reg  tagsWriteCmd_payload_data_regNextWhen_used;
  reg  tagsWriteCmd_payload_data_regNextWhen_dirty;
  reg [17:0] tagsWriteCmd_payload_data_regNextWhen_address;
  wire  _zz_6_;
  wire  way_tagReadRspOne_used;
  wire  way_tagReadRspOne_dirty;
  wire [17:0] way_tagReadRspOne_address;
  reg  way_dataReadRspOneKeepAddress;
  reg [11:0] way_dataReadRspOneAddress;
  wire [31:0] way_dataReadRspOneWithoutBypass;
  wire  _zz_7_;
  wire  _zz_8_;
  reg  dataWriteCmd_valid_regNextWhen;
  reg [11:0] dataWriteCmd_payload_address_regNextWhen;
  reg [31:0] _zz_9_;
  reg [3:0] _zz_10_;
  ...
  wire [17:0] way_tagReadRspTwoRegIn_address;
  reg  way_tagReadRspTwo_used;
  reg  way_tagReadRspTwo_dirty;
  reg [17:0] way_tagReadRspTwo_address;
  wire  way_dataReadRspTwoEnable;
  reg [11:0] way_dataReadRspOneAddress_regNextWhen;
  wire  _zz_13_;
  wire  _zz_14_;
  reg [7:0] _zz_15_;
  reg [7:0] _zz_16_;
  ...
  reg [19:0] way_tags [0:511];
  reg [7:0] way_data_symbol0 [0:4095];
  reg [7:0] way_data_symbol1 [0:4095];
  reg [7:0] way_data_symbol2 [0:4095];
  reg [7:0] way_data_symbol3 [0:4095];
  reg [7:0] _zz_53_;
  reg [7:0] _zz_54_;
  reg [7:0] _zz_55_;
  reg [7:0] _zz_56_;
  ...
  assign _zz_40_ = (stageB_mmuRsp_baseAddress[13 : 5] != (9'b111111111));
  ...
  always @ (*) begin
    ...
    dataReadCmd_payload = (12'bxxxxxxxxxxxx);
    way_dataReadRspOneKeepAddress = 1'b0;
    if((io_cpu_execute_isValid && (! io_cpu_execute_isStuck)))begin
      tagsReadCmd_valid = 1'b1;
      tagsReadCmd_payload = io_cpu_execute_args_address[13 : 5];
      dataReadCmd_valid = 1'b1;
      dataReadCmd_payload = io_cpu_execute_args_address[13 : 2];
    end
    ...
    if(victim_requestIn_halfPipe_valid)begin
      if(_zz_38_)begin
        ...
        dataReadCmd_valid = 1'b1;
        dataReadCmd_payload = {victim_requestIn_halfPipe_payload_address[13 : 5],victim_readLineCmdCounter[2 : 0]};
  ...
  always @ (*) begin
    ...
    tagsWriteCmd_payload_data_address = (18'bxxxxxxxxxxxxxxxxxx);
    dataWriteCmd_valid = 1'b0;
    dataWriteCmd_payload_address = (12'bxxxxxxxxxxxx);
    ...
    if(stageB_bootEvicts_valid)begin
      ...
      tagsWriteCmd_payload_address = stageB_mmuRsp_baseAddress[13 : 5];
    ...
    if(io_cpu_writeBack_isValid)begin
      ...
      case(stageB_request_kind)
        `DataCacheCpuCmdKind_defaultEncoding_MANAGMENT : begin
          ...
          victim_requestIn_payload_address = {{way_tagReadRspTwo_address,stageB_mmuRsp_baseAddress[13 : 5]},_zz_30_};
          tagsWriteCmd_payload_address = stageB_mmuRsp_baseAddress[13 : 5];
          ...
          if((((1'b0 || (! stageB_mmuRsp_miss)) && (! _zz_31_)) && (! _zz_32_)))begin
            if((stageB_request_forceUncachedAccess || stageB_mmuRsp_isIoAccess))begin
              ...
              if((stageB_waysHit || (! stageB_loadingNotDone)))begin
                ...
                dataWriteCmd_payload_address = stageB_mmuRsp_baseAddress[13 : 2];
                ...
                tagsWriteCmd_payload_data_address = stageB_mmuRsp_baseAddress[31 : 14];
              end else begin
                ...
                victim_requestIn_payload_address = {{way_tagReadRspTwo_address,stageB_mmuRsp_baseAddress[13 : 5]},_zz_34_};
              end
            end
          end
        end
    ...
    if((loader_valid && io_mem_rsp_valid))begin
      ...
      dataWriteCmd_payload_address = {stageB_mmuRsp_baseAddress[13 : 5],loader_counter_value};
  ...
  assign way_tagReadRspOne_address = (_zz_6_ ? tagsWriteCmd_payload_data_regNextWhen_address : _zz_4_[19 : 2]);
  ...
  always @ (posedge clk) begin
    ...
    if((! io_cpu_writeBack_isStuck))begin
      stageB_waysHit <= (way_tagReadRspTwoRegIn_used && (io_cpu_memory_mmuBus_rsp_physicalAddress[31 : 14] == way_tagReadRspTwoRegIn_address));
    end
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      if(stageB_bootEvicts_valid)begin
        if(_zz_40_)begin
          stageB_mmuRsp_baseAddress[13 : 5] <= (stageB_mmuRsp_baseAddress[13 : 5] + (9'b000000001));
        end else begin
...
module VexRiscvAxi4 (
  ...
  assign execute_NEXT_PC2 = _zz_34_;
  assign execute_TARGET_MISSMATCH2 = _zz_33_;
  assign execute_BRANCH_DO = _zz_37_;
  assign execute_BRANCH_CALC = _zz_35_;
  ...
  always @ (*) begin
    _zz_100_ = execute_FORMAL_PC_NEXT;
    if(_zz_116_)begin
      _zz_100_ = _zz_117_;
    end
  end
  ...
  always @ (*) begin
    ...
    _zz_118_ = 1'b0;
    _zz_119_ = (32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx);
  ...
  assign IBusCachedPlugin_fetchPc_preOutput_valid = _zz_127_;
  ...
  assign _zz_128_ = (! IBusCachedPlugin_iBusRsp_stages_0_halt);
  assign IBusCachedPlugin_iBusRsp_stages_0_input_ready = (IBusCachedPlugin_iBusRsp_stages_0_output_ready && _zz_128_);
  assign IBusCachedPlugin_iBusRsp_stages_0_output_valid = (IBusCachedPlugin_iBusRsp_stages_0_input_valid && _zz_128_);
  ...
  assign _zz_129_ = (! IBusCachedPlugin_iBusRsp_stages_1_halt);
  assign IBusCachedPlugin_iBusRsp_stages_1_input_ready = (IBusCachedPlugin_iBusRsp_stages_1_output_ready && _zz_129_);
  assign IBusCachedPlugin_iBusRsp_stages_1_output_valid = (IBusCachedPlugin_iBusRsp_stages_1_input_valid && _zz_129_);
  ...
  assign _zz_130_ = (! IBusCachedPlugin_stages_2_halt);
  assign IBusCachedPlugin_stages_2_input_ready = (IBusCachedPlugin_stages_2_output_ready && _zz_130_);
  assign IBusCachedPlugin_stages_2_output_valid = (IBusCachedPlugin_stages_2_input_valid && _zz_130_);
  assign IBusCachedPlugin_stages_2_output_payload = IBusCachedPlugin_stages_2_input_payload;
  assign IBusCachedPlugin_iBusRsp_stages_0_output_ready = _zz_131_;
  assign _zz_131_ = ((1'b0 && (! _zz_132_)) || IBusCachedPlugin_iBusRsp_stages_1_input_ready);
  assign _zz_132_ = _zz_133_;
  assign IBusCachedPlugin_iBusRsp_stages_1_input_valid = _zz_132_;
  assign IBusCachedPlugin_iBusRsp_stages_1_input_payload = IBusCachedPlugin_fetchPc_pcReg;
  assign IBusCachedPlugin_iBusRsp_stages_1_output_ready = ((1'b0 && (! _zz_134_)) || IBusCachedPlugin_stages_2_input_ready);
  assign _zz_134_ = _zz_135_;
  assign IBusCachedPlugin_stages_2_input_valid = _zz_134_;
  assign IBusCachedPlugin_stages_2_input_payload = _zz_136_;
  ...
  assign _zz_103_ = IBusCachedPlugin_iBusRsp_decodeInput_payload_rsp_rawInDecode;
  ...
  assign _zz_94_ = IBusCachedPlugin_predictor_injectorContext_hazard;
  assign _zz_95_ = IBusCachedPlugin_predictor_injectorContext_hit;
  assign _zz_96_ = IBusCachedPlugin_predictor_injectorContext_line_source;
  assign _zz_97_ = IBusCachedPlugin_predictor_injectorContext_line_branchWish;
  assign _zz_98_ = IBusCachedPlugin_predictor_injectorContext_line_target;
  always @ (*) begin
  ...
  assign _zz_33_ = (decode_PC != execute_BRANCH_CALC);
  assign execute_BranchPlugin_predictionMissmatch = ((((execute_PREDICTION_CONTEXT_hit && (! execute_PREDICTION_CONTEXT_hazard)) && execute_PREDICTION_CONTEXT_line_branchWish[1]) != execute_BRANCH_DO) || (execute_BRANCH_DO && execute_TARGET_MISSMATCH2));
  assign _zz_108_ = execute_PC;
  assign _zz_116_ = ((execute_arbitration_isValid && (! execute_arbitration_isStuckByOthers)) && execute_BranchPlugin_predictionMissmatch);
  assign _zz_117_ = (execute_BRANCH_DO ? execute_BRANCH_CALC : execute_NEXT_PC2);
  always @ (*) begin
    execute_exception_agregat_valid = ((execute_arbitration_isValid && execute_BRANCH_DO) && execute_BRANCH_CALC[1]);
    if(1'b0)begin
  ...
  assign CsrPlugin_exception = (CsrPlugin_exceptionPortCtrl_exceptionValids_writeBack && _zz_121_);
  ...
  assign contextSwitching = _zz_118_;
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      IBusCachedPlugin_fetchPc_pcReg <= (32'b10010000000000000000000000000000);   // bard0: resetVector -> 0x9000_0000 (DDR direct)
      ...
      if(_zz_131_)begin
        _zz_133_ <= IBusCachedPlugin_iBusRsp_stages_0_output_valid;
      end
      if(IBusCachedPlugin_iBusRsp_stages_1_output_ready)begin
        _zz_135_ <= IBusCachedPlugin_iBusRsp_stages_1_output_valid;
      end
      if((IBusCachedPlugin_jump_pcLoad_valid || _zz_106_))begin
        _zz_135_ <= 1'b0;
      end
  ...
  always @ (posedge clk) begin
    if(IBusCachedPlugin_iBusRsp_stages_1_output_ready)begin
      _zz_136_ <= IBusCachedPlugin_iBusRsp_stages_1_output_payload;
    end
